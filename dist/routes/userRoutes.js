...
router.post('/register', globalRateLimiter_1.globalRateLimiter, userController_1.registerUser);
router.post('/login', globalRateLimiter_1.globalRateLimiter, userController_1.loginUser);
